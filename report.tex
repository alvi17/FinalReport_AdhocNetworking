...
\HRule \\[0.4cm]
{ \huge \bfseries Ant Colony Based Routing Algorithm}\\[0.4cm] % Title of your document
\HRule \\[1cm]
...
\newpage
\begin{abstract}
There are many routing algorithm available these days. But designing an efficient one is a challenging task.In this paper a routing protocol based on Swarm intelligence is presented.
